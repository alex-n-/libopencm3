...
#define RCC_CFGR_SDPRE_0			(0x1F << 27)
#define RCC_CFGR_SDPRE_1			(0x1F << 28)
#define RCC_CFGR_SDPRE_2			(0x1F << 29)
#define RCC_CFGR_SDPRE_3			(0x1F << 30)
#define RCC_CFGR_SDPRE_4			(0x1F << 31)
