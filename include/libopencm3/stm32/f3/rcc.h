...
/* --- RCC_CFGR values ----------------------------------------------------- */
#define RCC_CFGR_SDPRE_4			(1 << 31)
#define RCC_CFGR_SDPRE_3			(1 << 30)
#define RCC_CFGR_SDPRE_2			(1 << 29)
#define RCC_CFGR_SDPRE_1			(1 << 28)
#define RCC_CFGR_SDPRE_0			(1 << 27)
#define RCC_CFGR_SDPRE_MASK			(0x1F << 27)
#define RCC_CFGR_MCOF				(1 << 24)
